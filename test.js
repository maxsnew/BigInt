...
Elm.Main.make = function (_elm) {
   ...
   $Native$Ports.incomingSignal(function (v) {
      return $Native$Json.fromJS(v);
   }));
   var squareRootTests = _L.fromArray([]);
   var comparisonTests = _L.fromArray([]);
   var divisionTests = _L.fromArray([]);
   var multiplicationTests = _L.fromArray([]);
   var subtractionTests = _L.fromArray([]);
   var additionTests = _L.fromArray([A2($ElmTest$Test.equals,
   $BigInt.fromString("101"),
   A2($BigInt.add,
   $BigInt.fromString("100"),
   $BigInt.one))]);
   var toStringTests = _L.fromArray([]);
   var fromStringTests = _L.fromArray([]);
   ...
   _elm.Main.values = {_op: _op
                      ,tests: tests
                      ,fromStringTests: fromStringTests
                      ,toStringTests: toStringTests
                      ,additionTests: additionTests
                      ,subtractionTests: subtractionTests
                      ,multiplicationTests: multiplicationTests
                      ,divisionTests: divisionTests
                      ,comparisonTests: comparisonTests
                      ,squareRootTests: squareRootTests
                      ,console: console};
   return _elm.Main.values;
};Elm.BigInt = Elm.BigInt || {};
Elm.BigInt.make = function (_elm) {
   "use strict";
   _elm.BigInt = _elm.BigInt || {};
   if (_elm.BigInt.values)
   return _elm.BigInt.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $moduleName = "BigInt",
   $Basics = Elm.Basics.make(_elm),
   $BigInt$Err = Elm.BigInt.Err.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $Either = Elm.Either.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var quotRem10 = function (s) {
      return {ctor: "_Tuple2"
             ,_0: s / 10 | 0
             ,_1: A2($Basics._op["%"],s,10)};
   };
   var addDigits = F2(function (ds1,
   ds2) {
      return function () {
         var pushCarry = F2(function (carry,
         acc) {
            return _U.eq(carry,
            0) ? acc : A2($List._op["::"],
            carry,
         ...
         var goOne = F3(function (acc,
         carry,
         ds) {
            return function () {
               switch (ds.ctor)
               {case "::": return function () {
                       var $ = quotRem10(ds._0 + carry),
                       carry$ = $._0,
                       d$ = $._1;
                       return A3(goOne,
                       A2($List._op["::"],d$,acc),
               ...
               {case "_Tuple2":
                  switch (_v4._0.ctor)
                    {case "::": switch (_v4._1.ctor)
                         {case "::": return function () {
                                 var $ = quotRem10(_v4._0._0 + _v4._1._0 + carry),
                                 carry$ = $._0,
                                 d = $._1;
                                 return A4(go,
                                 A2($List._op["::"],d,acc),
                            ...
                            case "[]": return A3(goOne,
                              acc,
                              carry + _v4._0._0,
                              _v4._0._1);}
                         break;
                       case "[]": switch (_v4._1.ctor)
                         {case "::": return A3(goWith,
                              acc,
                              _v4._1._0 + carry,
                              _v4._1._1);
                            case "[]": return A2(pushCarry,
   ...
   var fstDiff = function (ords) {
      return function () {
         var _v16 = A2(dropWhile,
         F2(function (x,y) {
            return _U.eq(x,y);
         })($Basics.EQ),
         ords);
         switch (_v16.ctor)
         {case "::": return _v16._0;
            case "[]": return $Basics.EQ;}
         _E.Case($moduleName,
         "between lines 310 and 312");
      }();
   };
   var compareDigits = F2(function (ds1,
   ds2) {
      return function () {
         var _v19 = A2($Basics.compare,
         $List.length(ds1),
         $List.length(ds2));
         switch (_v19.ctor)
         {case "EQ":
            return fstDiff($List.reverse(A3($List.zipWith,
              $Basics.compare,
              ds1,
              ds2)));}
         return _v19;
         ...
         {case "_Tuple2":
            switch (_v20._0.ctor)
              {case "Negative":
                 switch (_v20._1.ctor)
                   {case "Negative":
                      return A2(compareDigits,
                        _v20._1._0,
                        _v20._0._0);
                      case "Positive":
                      return $Basics.LT;
                      case "Zero": return $Basics.LT;}
                   break;
                 case "Positive":
                 switch (_v20._1.ctor)
                   {case "Negative":
                 ...
                 switch (_v20._1.ctor)
                   {case "Negative":
                      ...
                      case "Positive":
                      return $Basics.LT;
                      case "Zero": return $Basics.EQ;}
                   break;}
              break;}
         _E.Case($moduleName,
         "between lines 274 and 283");
      }();
   });
   var lt = F2(function (m,n) {
      return _U.eq($Basics.LT,
      A2(compare,m,n));
   });
   var gt = F2(function (m,n) {
      return _U.eq($Basics.GT,
      A2(compare,m,n));
   });
   var gte = F2(function (m,n) {
      return !_U.eq($Basics.LT,
      A2(compare,m,n));
   });
   var max = F2(function (m,n) {
      return function () {
         var _v31 = A2(compare,m,n);
         switch (_v31.ctor)
         {case "LT": return n;}
         return m;
      }();
   });
   var min = F2(function (m,n) {
      return function () {
         var _v32 = A2(compare,m,n);
         switch (_v32.ctor)
         {case "GT": return n;}
         return m;
      }();
   });
   var dropZeros = dropWhile(F2(function (x,
   y) {
      return _U.eq(x,y);
   })(0));
   var subtractFromGreater = F2(function (minuend,
   subtrahend) {
      return function () {
         var carryOut = F3(function (minuend,
         carry,
         diffAcc) {
            return function () {
               switch (minuend.ctor)
               {case "::": return function () {
                       var newM = minuend._0 - carry;
                       var $ = _U.cmp(newM,
                       0) < 0 ? {ctor: "_Tuple2"
                                ,_0: newM + 10
                                ,_1: 1} : {ctor: "_Tuple2"
         ...
         var go = F4(function (minuend,
         subtrahend,
         carry,
         diffAcc) {
            return function () {
               var _v36 = {ctor: "_Tuple2"
                          ,_0: minuend
                          ,_1: subtrahend};
               switch (_v36.ctor)
               {case "_Tuple2":
                  switch (_v36._0.ctor)
                    ...
                    {case "::":
                       switch (_v36._1.ctor)
                         {case "::": return function () {
                                 var newM = _v36._0._0 - carry;
                                 var $ = _U.cmp(newM,
                                 _v36._1._0) < 0 ? {ctor: "_Tuple2"
                                                   ,_0: newM + 10
                                                   ,_1: 1} : {ctor: "_Tuple2"
                                                             ,_0: newM
                                                             ,_1: 0},
         ...
         return $List.reverse(dropZeros(A4(go,
         minuend,
         subtrahend,
         0,
         _L.fromArray([]))));
   ...
   var toString = function (i) {
      return function () {
         var digitString = function ($) {
            return $String.join("")($List.map($String.show)($List.reverse($)));
         };
         return function () {
            switch (i.ctor)
            {case "Negative":
               return $String.cons(_U.chr("-"))(digitString(i._0));
               case "Positive":
               return digitString(i._0);
               case "Zero": return "0";}
            _E.Case($moduleName,
   ...
   var digits = $Dict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                             ,_0: _U.chr("0")
                                             ,_1: 0}
                                            ,{ctor: "_Tuple2"
                                             ,_0: _U.chr("1")
   ...
   var sumDigits = function ($) {
      return $List.sum($List.indexedMap(F2(function (i,
      d) {
   ...
   var Zero = {ctor: "Zero"};
   var zero = Zero;
   var Negative = function (a) {
      return {ctor: "Negative"
             ,_0: a};
   };
   var Positive = function (a) {
      return {ctor: "Positive"
             ,_0: a};
   };
   var safeFromString = function () {
      var interpret = function (_v46) {
         return function () {
            switch (_v46.ctor)
            {case "_Tuple2":
               return function () {
                    ...
                    var shortened = dropZeros(_v46._1);
                    return $List.isEmpty(shortened) ? Zero : A2(ctor,
                    _v46._0,
                    $List.reverse(shortened));
                 }();}
            _E.Case($moduleName,
            "between lines 73 and 78");
         }();
      };
      var readDigit = function (c) {
         return A2($Dict.get,
         c,
         digits);
      };
      var readDigits = function (_v50) {
         return function () {
            switch (_v50.ctor)
            {case "_Tuple2":
               return $BigInt$Err.map(F2(function (v0,
                 v1) {
                    return {ctor: "_Tuple2"
                           ,_0: v0
                           ,_1: v1};
                 })(_v50._0))($BigInt$Err.forEach(_v50._1)(function (c) {
                    return function () {
                       var _v54 = readDigit(c);
                       switch (_v54.ctor)
                       {case "Just":
                          return $Either.Right(_v54._0);
                          case "Nothing":
                          return $Either.Left(A2($String.cons,
                            c,
                            " is not a digit."));}
                       _E.Case($moduleName,
      ...
      var getSign = function (cs) {
         return function () {
            switch (cs.ctor)
            {case "::": switch (cs._0 + "")
                 {case "-": switch (cs._1.ctor)
                      {case "::":
                         return $Either.Right({ctor: "_Tuple2"
                                              ,_0: false
                                              ,_1: A2($List._op["::"],
                                              cs._1._0,
                                              cs._1._1)});}
                 ...
                 return $Either.Right({ctor: "_Tuple2"
                                      ...
                                      ,_1: cs});
               case "[]":
               return $Either.Left("Empty String is invalid Integer");}
            _E.Case($moduleName,
            "between lines 58 and 63");
         }();
      };
      return function ($) {
         return $BigInt$Err.map(interpret)(A2($BigInt$Err._op["<=<"],
         readDigits,
         getSign)($String.toList($)));
      };
   }();
   var fromString = function ($) {
      return A2($Either.either,
      $Native$Error.raise,
      $Basics.identity)(safeFromString($));
   };
   var fromInt = function (i) {
      return $Basics.not(_U.cmp(i,
      minInt) > -1 && _U.cmp(i,
      maxInt) < 1) ? $Native$Error.raise(_L.append($String.show(i),
      " is not an exact integer")) : function ($) {
         return fromString($String.show($));
      }(i);
   };
   var maxBInt = fromInt(maxInt);
   var minBInt = fromInt(minInt);
   var toInt = function (b) {
      return A2(lt,
      b,
      minBInt) || A2(gt,
      b,
      maxBInt) ? $Native$Error.raise(_L.append(toString(b),
      " is not small enough to be an exact int")) : function () {
         switch (b.ctor)
         {case "Negative":
            return function ($) {
                 return $Basics.negate(sumDigits($));
              }(b._0);
            case "Positive":
            return sumDigits(b._0);
            case "Zero": return 0;}
         _E.Case($moduleName,
         "between lines 44 and 47");
      }();
   };
   var one = fromString("1");
   var two = fromString("2");
   var negate = function (i) {
      return function () {
         switch (i.ctor)
         {case "Negative":
            return Positive(i._0);
            case "Positive":
            return Negative(i._0);
            case "Zero": return Zero;}
         _E.Case($moduleName,
         "between lines 115 and 118");
      }();
   };
   var negatively = function (_v67) {
      return function () {
         switch (_v67.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: _v67._1};}
         _E.Case($moduleName,
         "on line 229, column 22 to 33");
      }();
   };
   var subtractDigits = F2(function (pos,
   neg) {
      return function () {
         var _v71 = A2(compareDigits,
         pos,
         neg);
         switch (_v71.ctor)
         {case "EQ": return Zero;
            case "GT":
            return Positive(A2(subtractFromGreater,
              pos,
              neg));
            case "LT":
            return Negative(A2(subtractFromGreater,
              neg,
              pos));}
         _E.Case($moduleName,
         ...
         {case "_Tuple2":
            switch (_v72._0.ctor)
              ...
              {case "Negative":
                 switch (_v72._1.ctor)
                   {case "Negative":
                      return Negative(A2(addDigits,
                        _v72._0._0,
                        _v72._1._0));
                      case "Positive":
                      return A2(subtractDigits,
                        _v72._1._0,
                        _v72._0._0);}
                   break;
                 case "Positive":
   ...
   var inc = add(one);
   var subtract = F2(function (m,
   n) {
      return A2(add,m,negate(n));
   });
   var dec = function (m) {
      return A2(subtract,m,one);
   };
   var range = F2(function (lo,
   hi) {
      return function () {
         var _v81 = A2(compare,lo,hi);
         switch (_v81.ctor)
         {case "GT":
            return _L.fromArray([]);}
         return function () {
            var loop = F3(function (cur,
            left,
            acc) {
               return function () {
                  switch (left.ctor)
            ...
            return A3(loop,
            lo,
            A2(subtract,A2(add,hi,one),lo),
            _L.fromArray([]));
         }();
      }();
   });
   var multDigits = F2(function (ds1,
   ds2) {
      return function () {
         var $ = function () {
            var _v84 = A2(compareDigits,
            ds1,
            ds2);
            switch (_v84.ctor)
            {case "LT":
         ...
         big = $._0,
         less = $._1;
         var go = F2(function (less,
         acc) {
            return function () {
               switch (less.ctor)
               {case "Positive": return A2(go,
                    A2(subtract,less,one),
                    A2(add,big,acc));
                  case "Zero": return acc;}
               _E.Case($moduleName,
               "between lines 205 and 208");
            }();
         });
         return A2(go,less,Zero);
      }();
   });
   var multiply = F2(function (m,
   n) {
      return function () {
         var _v87 = {ctor: "_Tuple2"
                    ,_0: m
                    ,_1: n};
         switch (_v87.ctor)
         {case "_Tuple2":
            switch (_v87._0.ctor)
              ...
              {case "Negative":
                 switch (_v87._1.ctor)
                   {case "Negative":
                      return A2(multDigits,
                        _v87._0._0,
                        _v87._1._0);
                      case "Positive":
                      return negate(A2(multDigits,
                        _v87._0._0,
                        _v87._1._0));}
                   break;
                 case "Positive":
   ...
   var square = function (m) {
      return A2(multiply,m,m);
   };
   var divideDigits = F2(function (ds1,
   ds2) {
      return function () {
         var _v96 = A2(compareDigits,
         ds1,
         ds2);
         switch (_v96.ctor)
         {case "EQ":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: zero};
            case "GT": return function () {
                 var dvisor = Positive(ds2);
                 var go = F2(function (dvend,
                 acc) {
                    return function () {
                       var _v97 = A2(compare,
                       dvend,
                       ...
                       {case "EQ":
                          return {ctor: "_Tuple2"
                                 ,_0: A2(add,one,acc)
                                 ,_1: zero};
                          case "GT": return A2(go,
                            A2(subtract,dvend,dvisor),
                            A2(add,one,acc));
                          case "LT":
                          return {ctor: "_Tuple2"
                                 ,_0: acc
            ...
            return {ctor: "_Tuple2"
                   ...
                   ,_1: Positive(ds1)};}
         _E.Case($moduleName,
         "between lines 235 and 244");
      }();
   });
   var quotRem = F2(function (m,
   n) {
      return function () {
         var _v98 = {ctor: "_Tuple2"
                    ,_0: m
                    ,_1: n};
         switch (_v98.ctor)
         {case "_Tuple2":
            switch (_v98._1.ctor)
              {case "Zero":
                 return $Native$Error.raise("Error, quotRem: can\'t divide by zero");}
              switch (_v98._0.ctor)
              {case "Positive":
                 switch (_v98._1.ctor)
                   {case "Positive":
                      return A2(divideDigits,
                        _v98._0._0,
                        _v98._1._0);}
                   break;
                 case "Zero":
   ...
   var avg = F2(function (m,n) {
      return $Basics.fst(A2(quotRem,
      A2(add,m,n),
      two));
   });
   var flroot = function (m) {
      return function () {
         switch (m.ctor)
         {case "Negative":
            return $Native$Error.raise("Can\'t take square root of a negative number");
            case "Positive":
            switch (m._0.ctor)
              {case "::": switch (m._0._0)
                   {case 1: switch (m._0._1.ctor)
                        {case "[]":
                           return {ctor: "_Tuple2"
                                  ,_0: one
                                  ,_1: zero};}
                   ...
                   break;}
              return function () {
                 var rootRem = function (root) {
                    return A2(subtract,
                    m,
                    square(root));
                 };
                 var search = F2(function (lo,
                 hi) {
                    return _U.eq(inc(lo),
                    hi) ? {ctor: "_Tuple2"
                          ,_0: lo
                          ,_1: rootRem(lo)} : function () {
                       var mid = A2(avg,lo,hi);
                       return function () {
                          var _v110 = A2(compare,
                          square(mid),
                          m);
                          switch (_v110.ctor)
                          {case "EQ":
                             return {ctor: "_Tuple2"
                                    ,_0: mid
                                    ,_1: zero};
                             case "GT": return A2(search,
                               lo,
                               mid);
                             case "LT": return A2(search,
                               mid,
                               hi);}
                          _E.Case($moduleName,
                          "between lines 260 and 264");
                       }();
                    }();
                 });
                 return A2(search,zero,m);
              }();
            case "Zero":
            return {ctor: "_Tuple2"
                   ,_0: zero
                   ,_1: zero};}
         _E.Case($moduleName,
         "between lines 249 and 264");
      }();
   };
   _elm.BigInt.values = {_op: _op
                        ,Positive: Positive
                        ,Negative: Negative
                        ,Zero: Zero
                        ,fromInt: fromInt
                        ...
                        ,subtractFromGreater: subtractFromGreater
                        ,subtract: subtract
                        ,multiply: multiply
                        ,multDigits: multDigits
                        ,one: one
                        ,two: two
                        ,quotRem: quotRem
                        ,negatively: negatively
                        ,divideDigits: divideDigits
                        ,flroot: flroot
                        ,square: square
                        ,avg: avg
                        ,compare: compare
...
Elm.BigInt.Err = Elm.BigInt.Err || {};
Elm.BigInt.Err.make = function (_elm) {
   "use strict";
   _elm.BigInt = _elm.BigInt || {};
   _elm.BigInt.Err = _elm.BigInt.Err || {};
   if (_elm.BigInt.Err.values)
   return _elm.BigInt.Err.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _A = _N.Array.make(_elm),
   _E = _N.Error.make(_elm),
   $moduleName = "BigInt.Err",
   $Basics = Elm.Basics.make(_elm),
   $Either = Elm.Either.make(_elm),
   $List = Elm.List.make(_elm);
   var andThen = F2(function (e,
   k) {
   ...
   g,
   x) {
      return A2(andThen,g(x),f);
   });
   var forEach = F2(function (xs,
   k) {
      return function () {
         var consM = F2(function (ex,
         exs) {
            return A2(andThen,
            ex,
            function (x) {
               ...
               exs,
               function (xs) {
                  return $Either.Right(A2($List._op["::"],
                  x,
                  xs));
               });
            });
         ...
         consM,
         $Either.Right(_L.fromArray([])))($List.map(k)(xs));
      }();
   });
   var map = function (f) {
      return A2($Either.either,
   ...
   _elm.BigInt.Err.values = {_op: _op
                            ,map: map
                            ,andThen: andThen
                            ,forEach: forEach};
   return _elm.BigInt.Err.values;
...
Elm.ElmTest.Runner.String.make = function (_elm) {
   ...
   result) {
      return function () {
         ...
         return function () {
            ...
            {case "Fail":
               return _L.fromArray([{ctor: "_Tuple2"
                                    ,_0: indent(n)(_L.append(result._0,
                                    _L.append(": FAILED. ",
                                    result._1)))
                                    ,_1: result}]);
               case "Pass":
   ...
   var run = function (t) {
      return function () {
         ...
         var summary = vcat($List.map(indent(2))(_L.fromArray([_L.append($String.show($ElmTest$Test.numberOfSuites(t)),
                                                              _L.append(" suites run, containing ",
                                                              _L.append($String.show($ElmTest$Test.numberOfTests(t)),
                                                              " tests")))
                                                              ,_U.eq(failedTests$,
                                                              0) ? "All tests passed" : _L.append($String.show(passedSuites$),
                                                              _L.append(" suites and ",
                                                              _L.append($String.show(passedTests$),
                                                              " tests passed")))
                                                              ,_U.eq(failedTests$,
                                                              0) ? "" : _L.append($String.show(failedSuites$),
                                                              _L.append(" suites and ",
                                                              _L.append($String.show(failedTests$),
                                                              " tests failed")))])));
         var results$ = function () {
         ...
         {case "Suite":
            ...
            return function () {
                 ...
                 return function () {
                    switch (test._1.ctor)
                    {case "AssertEqual":
                       return runAssertion(test._1._0)(_L.append("Expected: ",
                         _L.append(test._1._1,
                         _L.append("; got: ",
                         test._1._2))));
                       case "AssertFalse":
                       return runAssertion(test._1._0)("not False");
                       case "AssertNotEqual":
                       return runAssertion(test._1._0)(_L.append(test._1._1,
                         _L.append(" equals ",
                         test._1._2)));
                       case "AssertTrue":
...
Elm.IO.Runner.make = function (_elm) {
   ...
   var serialize = function () {
      var mkObj = function ($) {
         return $Json.Object($Dict.fromList($));
      };
      var serReq = function (req) {
         return function () {
            switch (req.ctor)
            {case "Exit":
               return mkObj(_L.fromArray([{ctor: "_Tuple2"
                                          ,_0: "ctor"
                                          ,_1: $Json.String("Exit")}
                                         ,{ctor: "_Tuple2"
                                          ,_0: "val"
                                          ,_1: $Json.Number($Basics.toFloat(req._0))}]));
               case "Get":
               return mkObj(_L.fromArray([{ctor: "_Tuple2"
                                          ,_0: "ctor"
                                          ,_1: $Json.String("Get")}]));
               ...
               return mkObj(_L.fromArray([{ctor: "_Tuple2"
                                         ...
                                         ,{ctor: "_Tuple2"
                                          ,_0: "val"
                                          ,_1: $Json.String(req._0)}]));
               case "WriteFile":
               return mkObj(_L.fromArray([{ctor: "_Tuple2"
                                          ,_0: "ctor"
                                          ,_1: $Json.String("WriteFile")}
                                         ,{ctor: "_Tuple2"
                                          ,_0: "file"
                                          ,_1: $Json.String(req._0.file)}
                                         ,{ctor: "_Tuple2"
                                          ,_0: "content"
                                          ,_1: $Json.String(req._0.content)}]));}
            _E.Case($moduleName,
            "between lines 47 and 59");
         }();
      };
      return function ($) {
         return $Json.Array($List.map(serReq)($));
      };
   }();
            ...
            return function () {
                 ...
                 {case "Exit":
                    ...
                    return A2(_op[">>="],
                      ...
                      function (st) {
                         return function () {
                            var _v27 = $String.uncons(st.buffer);
                            switch (_v27.ctor)
                            {case "Just":
                               switch (_v27._0.ctor)
                                 {case "_Tuple2":
                                    return A2(_op[">>="],
                                      put({_: {},buffer: _v27._0._1}),
                                      function (_v31) {
                                         return function () {
                                            return extractRequests(io._0._0(_v27._0._0));
                                         }();
                                      });}
                                 break;
                               case "Nothing":
   ...
   io) {
      return function () {
         var third = function (_v54) {
            return function () {
               switch (_v54.ctor)
               {case "_Tuple3":
                  return _v54._2;}
               _E.Case($moduleName,
               "on line 31, column 28 to 29");
            }();
         };
   ...
   var flattenReqs = function (rs) {
      return function () {
         ...
         n) {
            return _U.cmp(n,
            100) > -1 ? $Trampoline.Continue(function (_v66) {
               return function () {
